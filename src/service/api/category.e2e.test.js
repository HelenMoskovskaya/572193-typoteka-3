...
const mockData = [
  {
    ...
    "comments": [
      ...
      {
        "id": `YicIwc`,
        "text": `Неплохо, но дорого.А сколько игр в комплекте?С чем связана продажа? Почему так дешёво?Продаю в связи с переездом. Отрываю от сердца.`
      },
      {
        "id": `JZ0xZG`,
        "text": `Совсем немного...А где блок питания?Почему в таком ужасном состоянии?Неплохо, но дорого.`
      },
      {
        "id": `VvrnRv`,
    ...
    "createdDate": `23.04.2021, 17:22:01`,
    "сategory": [`Без рамки`, `Кино`, `Железо`, `За жизнь`, `Музыка`, `Разное`, `Программирование`]
  },
  {
    "id": `Uoe6NR`,
    "comments": [
      ...
      {
        "id": `HhCHnt`,
        "text": `А сколько игр в комплекте?Почему в таком ужасном состоянии?Оплата наличными или перевод на карту?А где блок питания?`
      },
      {
        "id": `JAZTr7`,
        "text": `А где блок питания?`
